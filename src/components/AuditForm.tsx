...
export default function AuditForm({ onBack }: AuditFormProps) {
  ...
  return (
    ...
    >
      ...
      <button
  onClick={onBack}
  className="fixed top-6 start-6 z-40 flex items-center gap-2 text-white hover:text-[#ECDC2C] transition-colors font-semibold text-sm sm:text-base bg-black/50 hover:bg-black/60 rounded-md px-3 py-2"
>
            ...
            <>
              ...
              <div className="flex items-center justify-between gap-4">
                <button
                  ...
                  className="px-4 sm:px-6 py-2 text-gray-400 disabled:opacity-30 hover:text-white transition-colors text-sm sm:text-base bg-black/50 hover:bg-black/60 whitespace-nowrap"
                >
                  ← {t('buttons.previous')}
                </button>
